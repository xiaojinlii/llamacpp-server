...
from consul_register import lifespan, set_model_settings, init_consul
from consul_health_check import register_consul_health_check_router
...
def create_app(
    ...
    init_consul()
    register_consul_health_check_router(app)
    set_model_settings(model_settings=model_settings)
